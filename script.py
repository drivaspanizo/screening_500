# Create comprehensive S&P 500 data fetcher with full universe coverage
import pandas as pd
...
# Save the Python fetcher script
with open('sp500_data_fetcher.py', 'w') as f:
    f.write(sp500_fetcher_code)

print("Created comprehensive S&P 500 data fetcher script")